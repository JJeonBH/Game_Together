...
<%@ include file="../common/head.jsp" %>
	...
	<section class="mt-6 mb-20 mx-20 text-lg min-w-1000">
		<div class="mt-6 flex">
			<a href="/usr/article/list?boardType=lol" class="w-1/2"><img class="main-image w-full" src="/resource/images/게임이미지.jpg" alt="리그오브레전드 이미지"></a>
			<a href="/usr/article/list?boardType=bg" class="ml-4 w-1/2"><img class="main-image w-full" src="/resource/images/게임이미지.jpg" alt="배틀그라운드 이미지"></a>
		</div>
	</section>
