...
<%@ include file="../common/head.jsp" %>
	<script type="text/javascript">
		function submitPasswordCheckForm(form) {
	...
	<section class="text-lg mt-10 mb-20 min-w-900">
		<div class="flex justify-center">
			<form action="modify" method="POST" class="border border-red-200 p-5" onsubmit="submitPasswordCheckForm(this); return false;">
				<div>
				...
				<div class="mt-8">
					<button class="btn-text-color btn btn-info w-112">확인</button>
				</div>
			</form>
		</div>
